    ...
    <section className="px-4 py-8 md:py-10 bg-background-muted">
      <div className='container mx-auto'>
        ...
        <div className="text-center max-w-3xl mx-auto mb-6 md:mb-12">
          ...
          <h2 className="text-[28px] text-text-dark md:text-5xl font-medium mb-4 md:mb-6 leading-[1.2]">We Don’t Just Build. We Scale.</h2>
        ...
        {/* Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-[36%_32%_32%] gap-4">
          {/* Left Large Card */}
          <div className="bg-white relative overflow-hidden rounded-3xl p-6 md:p-10 flex flex-col justify-between gap-6 lg:row-span-2">
            <div>
              <h3 className="text-2xl text-text-dark font-medium mb-2 md:mb-4">Embedded Growth Team,<br className='hidden md:block' /> Aligned to Win</h3>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-white via-white/2 to-transparent pointer-events-none"></div>
          </div>
          ...
          <div className="relative rounded-3xl p-[1.5px] bg-[linear-gradient(137.84deg,#F3F8FF_0%,#EDF2F9_100%)]">
            <div className="bg-white rounded-3xl p-6 md:p-8 h-full">
              ...
              <h3 className="text-2xl text-text-dark font-medium mb-2">Full-Funnel<br className='hidden md:block' /> Shopify Expertise</h3>
              <p className="text-text-light tracking-[0.04rem]">
          ...
          <div className="relative rounded-3xl p-[1.5px] bg-[linear-gradient(137.84deg,#F3F8FF_0%,#EDF2F9_100%)]">
            <div className="bg-white rounded-3xl p-6 md:p-8 h-full">
              ...
              <h3 className="text-2xl text-text-dark font-medium mb-2">Smarter Automation,<br className='hidden md:block' /> Real ROI</h3>
              <p className="text-text-light tracking-[0.04rem]">
          ...
          <div className="relative rounded-3xl p-[1.5px] bg-[linear-gradient(137.84deg,#F3F8FF_0%,#EDF2F9_100%)]">
            <div className="bg-white rounded-3xl p-6 md:p-8 h-full">
              ...
              <h3 className="text-2xl text-text-dark font-medium mb-2">Direct, Decisive<br className='hidden md:block' /> Communication</h3>
              <p className="text-text-light tracking-[0.04rem]">
