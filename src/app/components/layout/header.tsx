          ...
          <div className="px-4 md:px-6 py-2 md:py-[9.5px]">
            <div className="flex justify-center md:justify-between items-center md:gap-5">
              ...
              <nav className="hidden md:flex md:gap-16 sm:gap-10 font-medium uppercase">
                ...
                <Link href="#"><Button className={`uppercase h-max p-0 ${isServiceDetailsPage ? 'text-white' : 'text-text-dark'}`} variant="link">Blogs</Button></Link>
              </nav>

              {/* CTA Button */}
              <div className='mr-3 md:mr-0'>
                <Link href="#">
                  <Button size="sm" className={`flex items-center gap-2 md:w-45 text-sm md:text-base ${isServiceDetailsPage ? 'bg-white text-primary' : ''}`}>Schedule a Call
